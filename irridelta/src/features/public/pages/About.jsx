...
import { Lightbulb, TrendingUp, Handshake, Facebook, Instagram } from 'lucide-react';
  ...
  return (
    <div className="w-full bg-white">
      ...
      <section className="py-16 bg-blue-600 text-white text-center">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-extrabold mb-4">¡Conocé al equipo que lo hace posible!</h2>
